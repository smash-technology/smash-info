            ...
            >
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      Static Pages For Prospective Students
                    </div>
                    <div className="text-gray-600">
                      Prospective learners and partners can learn about Smash
                      and how to get started through the Home, About Us, Student
                      Guide, Industry pages and more.{" "}
                    </div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      Onboarding and Surveys
                    </div>
                    <div className="text-gray-600">
                      To sign up, users can easily register and create an
                      account to start their Smash journey. With every log in,
                      users are welcomed with short surveys that are used to
                      update their information and personalize their experience.
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      To track learning progress and achievements, the dashboard
                      is an engaging way for users to view their performance.
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      Users can record their accomplishments and apply to
                      projects with the auto-filled resume that retrieves
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      ...
                      projects. Applying is made simple by sending the user’s
                      resume straight to the project sponsor.{" "}
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg
